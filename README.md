...
<br>Винты к моторам установлены через пружинный муфты, на концах валов овальная выточка, между валом двигателей я винтами установлены шарики от подшипников диметров ~5мм
